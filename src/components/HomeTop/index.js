    ...
    <div className="col-40 text-center text-white">
      <div className="container w-50">
        ...
        <p className="text-start social-text">
          <a className="link-hover-teal" href="https://www.linkedin.com/in/nathaniel-ehrlich-018758121/">
            LinkedIn
          </a>{" |"}
    ...
    <div className="col-40 text-white">
      <div className="container w-50">
        ...
        <p>
          ...
          and working on completeing my Full Stack Web Developer certification
          from University of Denver. I am a highly motivated individual with a
          mindset to continuously learn and expand my knowledge base.
        </p>
      </div>
    </div>
  );
